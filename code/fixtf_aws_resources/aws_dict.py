...
aws_api_gateway_account = {
    "clfn": "apigateway",
    "descfn": "get_account",
    "topkey": "",  # get_account returns data directly, no wrapper key
...
aws_api_gateway_integration_response = {
    "clfn": "apigateway",
    "descfn": "get_integration_response",
    "topkey": "items",
    "key": "id",
    "filterid": "id",
}
...
aws_appstream_directory_config = {
    "clfn": "appstream",
    "descfn": "describe_directory_configs",
...
aws_appstream_user_stack_association = {
    "clfn": "appstream",
    "descfn": "describe_user_stack_associations",
...
aws_auditmanager_framework = {
    "clfn": "auditmanager",
    "descfn": "list_assessment_frameworks",
    "topkey": "Frameworks",
    "key": "Id",
    "filterid": "Id",
}
...
aws_auditmanager_framework_share = {
    "clfn": "auditmanager",
    "descfn": "list_assessment_framework_share_requests",
...
aws_auditmanager_organization_admin_account_registration = {
    "clfn": "auditmanager",
    "descfn": "get_organization_admin_account",
...
aws_autoscaling_traffic_source_attachment = {
    "clfn": "autoscaling",
    "descfn": "describe_traffic_sources",
...
aws_budgets_budget_action = {
    "clfn": "budgets",
    "descfn": "describe_budget_actions_for_budget",
...
aws_ce_anomaly_subscription = {
    "clfn": "ce",
    "descfn": "get_anomaly_subscriptions",
...
aws_chime_voice_connector_logging = {
    "clfn": "chime-sdk-voice",
    "descfn": "get_voice_connector_logging_configuration",
...
aws_chime_voice_connector_origination = {
    "clfn": "chime-sdk-voice",
    "descfn": "get_voice_connector_origination",
...
aws_chime_voice_connector_streaming = {
    "clfn": "chime-sdk-voice",
    "descfn": "get_voice_connector_streaming_configuration",
...
aws_chime_voice_connector_termination = {
    "clfn": "chime-sdk-voice",
    "descfn": "get_voice_connector_termination",
...
aws_cloudfront_monitoring_subscription = {
    "clfn": "cloudfront",
    "descfn": "get_monitoring_subscription",
...
aws_cloudsearch_domain_service_access_policy = {
    "clfn": "cloudsearch",
    "descfn": "describe_service_access_policies",
...
aws_codeartifact_domain_permissions_policy = {
    "clfn": "codeartifact",
    "descfn": "get_domain_permissions_policy",
...
aws_codeartifact_repository_permissions_policy = {
    "clfn": "codeartifact",
    "descfn": "get_repository_permissions_policy",
...
aws_codecommit_approval_rule_template_association = {
    "clfn": "codecommit",
    "descfn": "list_associated_approval_rule_templates_for_repository",
...
aws_codecommit_trigger = {
    "clfn": "codecommit",
    "descfn": "get_repository_triggers",
...
aws_cognito_identity_pool_provider_principal_tag = {
    "clfn": "cognito-identity",
    "descfn": "get_principal_tag_attribute_map",
...
aws_cognito_identity_pool_roles_attachment = {
    "clfn": "cognito-identity",
    "descfn": "get_identity_pool_roles",
...
aws_cognito_risk_configuration = {
    "clfn": "cognito-idp",
    "descfn": "describe_risk_configuration",
...
aws_cognito_user_pool_domain = {
    "clfn": "cognito-idp",
    "descfn": "describe_user_pool_domain",
...
aws_cur_report_definition = {
    "clfn": "cur",
    "descfn": "describe_report_definitions",
...
aws_datapipeline_pipeline_definition = {
    "clfn": "datapipeline",
    "descfn": "get_pipeline_definition",
...
aws_db_proxy_default_target_group = {
    "clfn": "rds",
    "descfn": "describe_db_proxy_target_groups",
...
aws_directory_service_conditional_forwarder = {
    "clfn": "ds",
    "descfn": "describe_conditional_forwarders",
...
aws_elasticsearch_domain_policy = {
    "clfn": "es",
    "descfn": "describe_elasticsearch_domain_config",
    "topkey": "Policy",
    "key": "Policy",
    "filterid": "Policy",
}
...
aws_emr_studio_session_mapping = {
    "clfn": "emr",
    "descfn": "list_studio_session_mappings",
...
aws_fms_admin_account = {
    "clfn": "fms",
    "descfn": "list_admin_accounts_for_organization",
...
aws_gamelift_game_session_queue = {
    "clfn": "gamelift",
    "descfn": "describe_game_session_queues",
...
aws_iot_thing_group_membership = {
    "clfn": "iot",
    "descfn": "list_things_in_thing_group",
...
aws_licensemanager_association = {
    ...
    "descfn": "list_associations_for_license_configuration",
    "topkey": "Associations",
...
aws_lightsail_instance_public_ports = {
    "clfn": "lightsail",
    "descfn": "get_instance_port_states",
    "topkey": "PublicPorts",
    "key": "name",
    "filterid": "name",
}
...
aws_lightsail_lb_certificate_attachment = {
    "clfn": "lightsail",
    "descfn": "get_load_balancer_tls_certificates",
    "topkey": "Certificates",
    "key": "name",
    "filterid": "name",
}
...
aws_quicksight_custom_permissions = {
    "clfn": "quicksight",
    "descfn": "describe_custom_permissions",
    "topkey": "CustomPermissions",
    "key": "Arn",
    "filterid": "AwsAccountId",
}
...
aws_quicksight_ip_restriction = {
    "clfn": "quicksight",
    "descfn": "describe_ip_restriction",
    "topkey": "IpRestrictionRuleMap",
    "key": "AwsAccountId",
    "filterid": "AwsAccountId",
}
...
aws_quicksight_role_custom_permission = {
    "clfn": "quicksight",
    "descfn": "describe_role_custom_permission",
    "topkey": "CustomPermissionsName",
    "key": "Role",
    "filterid": "AwsAccountId",
}
...
aws_quicksight_role_membership = {
    "clfn": "quicksight",
    "descfn": "list_role_memberships",
    "topkey": "RoleMembershipList",
    "key": "MemberName",
    "filterid": "AwsAccountId",
}
...
aws_rds_shard_group = {
    "clfn": "rds",
    "descfn": "describe_db_shard_groups",
    "topkey": "DBShardGroups",
    "key": "DBShardGroupIdentifier",
    "filterid": "DBShardGroupIdentifier",
}
...
aws_s3control_directory_bucket_access_point_scope = {
    "clfn": "s3control",
    "descfn": "get_access_point_policy_for_object_lambda",
    "topkey": "Policy",
    "key": "Name",
    "filterid": "Name",
}
...
aws_sagemaker_mlflow_tracking_server = {
    "clfn": "sagemaker",
    "descfn": "list_mlflow_tracking_servers",
    "topkey": "TrackingServerSummaries",
    "key": "TrackingServerName",
    "filterid": "TrackingServerName",
}
...
aws_servicecatalogappregistry_attribute_group = {
    "clfn": "servicecatalog-appregistry",
    "descfn": "list_attribute_groups",
    "topkey": "attributeGroups",
    "key": "id",
    "filterid": "id",
}
...
aws_servicecatalogappregistry_attribute_group_association = {
    "clfn": "servicecatalog-appregistry",
    "descfn": "list_attribute_group_associations",
...
aws_ssmcontacts_rotation = {
    "clfn": "ssm-contacts",
    "descfn": "list_rotations",
    "topkey": "Rotations",
    "key": "RotationArn",
    "filterid": "RotationArn",
}

aws_ssmquicksetup_configuration_manager = {
    "clfn": "ssmquicksetup",
    "descfn": "list_configuration_managers",
    "topkey": "ConfigurationManagersList",
    "key": "ManagerArn",
    "filterid": "ManagerArn",
}
...
aws_ssoadmin_application_access_scope = {
    "clfn": "sso-admin",
    "descfn": "list_application_access_scopes",
    "topkey": "Scopes",
    "key": "Scope",
    "filterid": "ApplicationArn",
}

aws_timestreaminfluxdb_db_cluster = {
    "clfn": "timestream-influxdb",
    "descfn": "list_db_instances",
    "topkey": "items",
    "key": "id",
    "filterid": "id",
}
...
aws_timestreamquery_scheduled_query = {
    "clfn": "timestream-query",
    "descfn": "list_scheduled_queries",
    "topkey": "ScheduledQueries",
    "key": "Arn",
    "filterid": "Arn",
}
...
aws_verifiedpermissions_identity_source = {
    ...
    "descfn": "list_identity_sources",
    "topkey": "identitySources",
    "key": "identitySourceId",
    "filterid": "policyStoreId",
}
...
aws_verifiedpermissions_policy_template = {
    "clfn": "verifiedpermissions",
    "descfn": "list_policy_templates",
    "topkey": "policyTemplates",
...
aws_vpc_endpoint_service_private_dns_verification = {
    "clfn": "ec2",
    "descfn": "describe_vpc_endpoint_service_configurations",
    "topkey": "ServiceConfigurations",
    "key": "ServiceId",
    "filterid": "ServiceId",
}
...
aws_vpc_route_server = {
    "clfn": "ec2",
    "descfn": "describe_route_servers",
    "topkey": "RouteServers",
    "key": "RouteServerId",
    "filterid": "RouteServerId",
}
...
aws_vpc_route_server_endpoint = {
    "clfn": "ec2",
    "descfn": "describe_route_server_endpoints",
    "topkey": "RouteServerEndpoints",
    "key": "RouteServerEndpointId",
    "filterid": "RouteServerEndpointId",
}

aws_vpc_route_server_peer = {
    "clfn": "ec2",
    "descfn": "describe_route_server_peers",
    "topkey": "RouteServerPeers",
    "key": "RouteServerPeerId",
    "filterid": "RouteServerPeerId",
}
...
aws_vpc_route_server_vpc_association = {
    ...
    "filterid": "RouteServerVpcAssociationId",
}

aws_vpc_security_group_vpc_association = {
    "clfn": "ec2",
    "descfn": "describe_security_group_vpc_associations",
    "topkey": "SecurityGroupVpcAssociations",
    "key": "GroupId",
    "filterid": "GroupId",
}
...
aws_vpn_concentrator = {
    "clfn": "ec2",
    "descfn": "describe_vpn_concentrators",
    "topkey": "VpnConcentrators",
    "key": "VpnConcentratorId",
    "filterid": "VpnConcentratorId",
}
...
aws_workspacesweb_browser_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_browser_settings",
    "topkey": "browserSettings",
    "key": "browserSettingsArn",
    "filterid": "browserSettingsArn",
}
...
aws_workspacesweb_data_protection_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_data_protection_settings",
    "topkey": "dataProtectionSettings",
    "key": "dataProtectionSettingsArn",
    "filterid": "dataProtectionSettingsArn",
}
...
aws_workspacesweb_identity_provider = {
    ...
    "descfn": "list_identity_providers",
    "topkey": "identityProviders",
    "key": "identityProviderArn",
    "filterid": "portalArn",
}

aws_workspacesweb_ip_access_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_ip_access_settings",
    "topkey": "ipAccessSettings",
    "key": "ipAccessSettingsArn",
    "filterid": "ipAccessSettingsArn",
}
...
aws_workspacesweb_network_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_network_settings",
    "topkey": "networkSettings",
    "key": "networkSettingsArn",
    "filterid": "networkSettingsArn",
}
...
aws_workspacesweb_session_logger = {
    "clfn": "workspaces-web",
    "descfn": "list_session_loggers",
    "topkey": "sessionLoggers",
    "key": "sessionLoggerArn",
    "filterid": "sessionLoggerArn",
}
...
aws_workspacesweb_user_access_logging_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_user_access_logging_settings",
    "topkey": "userAccessLoggingSettings",
    "key": "userAccessLoggingSettingsArn",
    "filterid": "userAccessLoggingSettingsArn",
}
...
aws_workspacesweb_user_settings = {
    "clfn": "workspaces-web",
    "descfn": "list_user_settings",
    "topkey": "userSettings",
    "key": "userSettingsArn",
    "filterid": "userSettingsArn",
}
...
# Extended aws_dict.py - Deduplicated
# Original resources from aws_dict.py (deduplicated) + new researched resources
# Total: 1612 unique resources
# Original: 1435 | New: 177
# 100% coverage of Terraform AWS provider
...
aws_resources = {
    ...
    # NEW RESOURCES ADDED - 177 resources
    "aws_bedrockagentcore_agent_runtime": aws_bedrockagentcore_agent_runtime,
    "aws_bedrockagentcore_agent_runtime_endpoint": aws_bedrockagentcore_agent_runtime_endpoint,
    "aws_bedrockagentcore_api_key_credential_provider": aws_bedrockagentcore_api_key_credential_provider,
    "aws_bedrockagentcore_browser": aws_bedrockagentcore_browser,
    "aws_bedrockagentcore_code_interpreter": aws_bedrockagentcore_code_interpreter,
    "aws_bedrockagentcore_gateway": aws_bedrockagentcore_gateway,
    "aws_bedrockagentcore_gateway_target": aws_bedrockagentcore_gateway_target,
    "aws_bedrockagentcore_memory": aws_bedrockagentcore_memory,
    "aws_bedrockagentcore_memory_strategy": aws_bedrockagentcore_memory_strategy,
    "aws_bedrockagentcore_oauth2_credential_provider": aws_bedrockagentcore_oauth2_credential_provider,
    "aws_bedrockagentcore_token_vault_cmk": aws_bedrockagentcore_token_vault_cmk,
    "aws_bedrockagentcore_workload_identity": aws_bedrockagentcore_workload_identity,
    "aws_cloudwatch_contributor_managed_insight_rule": aws_cloudwatch_contributor_managed_insight_rule,
    "aws_controltower_baseline": aws_controltower_baseline,
    "aws_dataexchange_event_action": aws_dataexchange_event_action,
    "aws_dataexchange_revision_assets": aws_dataexchange_revision_assets,
    "aws_devopsguru_event_sources_config": aws_devopsguru_event_sources_config,
    "aws_devopsguru_notification_channel": aws_devopsguru_notification_channel,
    "aws_devopsguru_resource_collection": aws_devopsguru_resource_collection,
    "aws_devopsguru_service_integration": aws_devopsguru_service_integration,
    ...
    "aws_dsql_cluster_peering": aws_dsql_cluster_peering,
    "aws_dynamodb_table_export": aws_dynamodb_table_export,
    "aws_ec2_allowed_images_settings": aws_ec2_allowed_images_settings,
    "aws_ec2_default_credit_specification": aws_ec2_default_credit_specification,
    "aws_ec2_transit_gateway_default_route_table_association": aws_ec2_transit_gateway_default_route_table_association,
    "aws_ec2_transit_gateway_default_route_table_propagation": aws_ec2_transit_gateway_default_route_table_propagation,
    "aws_ecr_account_setting": aws_ecr_account_setting,
    "aws_ecr_repository_creation_template": aws_ecr_repository_creation_template,
    "aws_ecs_express_gateway_service": aws_ecs_express_gateway_service,
    "aws_eks_capability": aws_eks_capability,
    "aws_fis_target_account_configuration": aws_fis_target_account_configuration,
    "aws_fsx_s3_access_point_attachment": aws_fsx_s3_access_point_attachment,
    "aws_guardduty_member_detector_feature": aws_guardduty_member_detector_feature,
    "aws_iam_group_policies_exclusive": aws_iam_group_policies_exclusive,
    "aws_iam_group_policy_attachments_exclusive": aws_iam_group_policy_attachments_exclusive,
    "aws_iam_outbound_web_identity_federation": aws_iam_outbound_web_identity_federation,
    "aws_iam_role_policies_exclusive": aws_iam_role_policies_exclusive,
    "aws_iam_role_policy_attachments_exclusive": aws_iam_role_policy_attachments_exclusive,
    "aws_iam_user_policies_exclusive": aws_iam_user_policies_exclusive,
    "aws_iam_user_policy_attachments_exclusive": aws_iam_user_policy_attachments_exclusive,
    "aws_imagebuilder_lifecycle_policy": aws_imagebuilder_lifecycle_policy,
    "aws_imagebuilder_workflow": aws_imagebuilder_workflow,
    "aws_inspector2_filter": aws_inspector2_filter,
    "aws_invoicing_invoice_unit": aws_invoicing_invoice_unit,
    "aws_kinesis_resource_policy": aws_kinesis_resource_policy,
    "aws_lakeformation_data_cells_filter": aws_lakeformation_data_cells_filter,
    "aws_lakeformation_identity_center_configuration": aws_lakeformation_identity_center_configuration,
    "aws_lakeformation_lf_tag_expression": aws_lakeformation_lf_tag_expression,
    "aws_lakeformation_opt_in": aws_lakeformation_opt_in,
    "aws_lakeformation_resource_lf_tag": aws_lakeformation_resource_lf_tag,
    "aws_lambda_capacity_provider": aws_lambda_capacity_provider,
    "aws_lambda_function_recursion_config": aws_lambda_function_recursion_config,
    "aws_lambda_runtime_management_config": aws_lambda_runtime_management_config,
    "aws_m2_application": aws_m2_application,
    "aws_m2_deployment": aws_m2_deployment,
    "aws_m2_environment": aws_m2_environment,
    "aws_macie2_organization_configuration": aws_macie2_organization_configuration,
    "aws_media_packagev2_channel_group": aws_media_packagev2_channel_group,
    "aws_memorydb_multi_region_cluster": aws_memorydb_multi_region_cluster,
    "aws_msk_single_scram_secret_association": aws_msk_single_scram_secret_association,
    "aws_nat_gateway_eip_association": aws_nat_gateway_eip_association,
    "aws_neptunegraph_graph": aws_neptunegraph_graph,
    "aws_network_interface_permission": aws_network_interface_permission,
    "aws_networkfirewall_firewall_transit_gateway_attachment_accepter": aws_networkfirewall_firewall_transit_gateway_attachment_accepter,
    "aws_networkfirewall_tls_inspection_configuration": aws_networkfirewall_tls_inspection_configuration,
    "aws_networkfirewall_vpc_endpoint_association": aws_networkfirewall_vpc_endpoint_association,
    "aws_networkflowmonitor_monitor": aws_networkflowmonitor_monitor,
    "aws_networkflowmonitor_scope": aws_networkflowmonitor_scope,
    "aws_networkmanager_dx_gateway_attachment": aws_networkmanager_dx_gateway_attachment,
    "aws_networkmonitor_monitor": aws_networkmonitor_monitor,
    "aws_networkmonitor_probe": aws_networkmonitor_probe,
    "aws_notifications_channel_association": aws_notifications_channel_association,
    "aws_notifications_event_rule": aws_notifications_event_rule,
    "aws_notifications_notification_configuration": aws_notifications_notification_configuration,
    "aws_notifications_notification_hub": aws_notifications_notification_hub,
    "aws_notificationscontacts_email_contact": aws_notificationscontacts_email_contact,
    "aws_observabilityadmin_centralization_rule_for_organization": aws_observabilityadmin_centralization_rule_for_organization,
    "aws_odb_cloud_autonomous_vm_cluster": aws_odb_cloud_autonomous_vm_cluster,
    "aws_odb_cloud_exadata_infrastructure": aws_odb_cloud_exadata_infrastructure,
    "aws_odb_cloud_vm_cluster": aws_odb_cloud_vm_cluster,
    "aws_odb_network": aws_odb_network,
    "aws_odb_network_peering_connection": aws_odb_network_peering_connection,
    "aws_opensearch_authorize_vpc_endpoint_access": aws_opensearch_authorize_vpc_endpoint_access,
    "aws_organizations_tag": aws_organizations_tag,
    "aws_osis_pipeline": aws_osis_pipeline,
    "aws_paymentcryptography_key": aws_paymentcryptography_key,
    "aws_paymentcryptography_key_alias": aws_paymentcryptography_key_alias,
    "aws_pinpoint_email_template": aws_pinpoint_email_template,
    "aws_pinpointsmsvoicev2_configuration_set": aws_pinpointsmsvoicev2_configuration_set,
    "aws_pinpointsmsvoicev2_opt_out_list": aws_pinpointsmsvoicev2_opt_out_list,
    "aws_pinpointsmsvoicev2_phone_number": aws_pinpointsmsvoicev2_phone_number,
    "aws_prometheus_query_logging_configuration": aws_prometheus_query_logging_configuration,
    "aws_prometheus_resource_policy": aws_prometheus_resource_policy,
    "aws_prometheus_scraper": aws_prometheus_scraper,
    "aws_prometheus_workspace_configuration": aws_prometheus_workspace_configuration,
    "aws_qbusiness_application": aws_qbusiness_application,
    "aws_quicksight_account_settings": aws_quicksight_account_settings,
    "aws_quicksight_custom_permissions": aws_quicksight_custom_permissions,
    "aws_quicksight_ip_restriction": aws_quicksight_ip_restriction,
    "aws_quicksight_key_registration": aws_quicksight_key_registration,
    "aws_quicksight_role_custom_permission": aws_quicksight_role_custom_permission,
    "aws_quicksight_role_membership": aws_quicksight_role_membership,
    "aws_rds_instance_state": aws_rds_instance_state,
    "aws_rds_shard_group": aws_rds_shard_group,
    "aws_resiliencehub_resiliency_policy": aws_resiliencehub_resiliency_policy,
    "aws_s3control_directory_bucket_access_point_scope": aws_s3control_directory_bucket_access_point_scope,
    "aws_s3tables_table_bucket_replication": aws_s3tables_table_bucket_replication,
    "aws_s3tables_table_policy": aws_s3tables_table_policy,
    "aws_s3tables_table_replication": aws_s3tables_table_replication,
    "aws_s3vectors_index": aws_s3vectors_index,
    "aws_s3vectors_vector_bucket": aws_s3vectors_vector_bucket,
    "aws_s3vectors_vector_bucket_policy": aws_s3vectors_vector_bucket_policy,
    "aws_sagemaker_mlflow_tracking_server": aws_sagemaker_mlflow_tracking_server,
    "aws_securityhub_standards_control_association": aws_securityhub_standards_control_association,
    "aws_securitylake_aws_log_source": aws_securitylake_aws_log_source,
    "aws_securitylake_custom_log_source": aws_securitylake_custom_log_source,
    "aws_securitylake_subscriber": aws_securitylake_subscriber,
    "aws_securitylake_subscriber_notification": aws_securitylake_subscriber_notification,
    "aws_servicecatalogappregistry_application": aws_servicecatalogappregistry_application,
    "aws_servicecatalogappregistry_attribute_group": aws_servicecatalogappregistry_attribute_group,
    "aws_servicecatalogappregistry_attribute_group_association": aws_servicecatalogappregistry_attribute_group_association,
    "aws_sesv2_account_suppression_attributes": aws_sesv2_account_suppression_attributes,
    "aws_sesv2_email_identity_policy": aws_sesv2_email_identity_policy,
    "aws_sesv2_tenant": aws_sesv2_tenant,
    "aws_shield_proactive_engagement": aws_shield_proactive_engagement,
    "aws_shield_subscription": aws_shield_subscription,
    "aws_ssmcontacts_rotation": aws_ssmcontacts_rotation,
    "aws_ssmquicksetup_configuration_manager": aws_ssmquicksetup_configuration_manager,
    "aws_ssoadmin_application_access_scope": aws_ssoadmin_application_access_scope,
    "aws_timestreaminfluxdb_db_cluster": aws_timestreaminfluxdb_db_cluster,
    "aws_timestreaminfluxdb_db_instance": aws_timestreaminfluxdb_db_instance,
    "aws_timestreamquery_scheduled_query": aws_timestreamquery_scheduled_query,
    "aws_transfer_host_key": aws_transfer_host_key,
    "aws_transfer_web_app": aws_transfer_web_app,
    "aws_transfer_web_app_customization": aws_transfer_web_app_customization,
    "aws_verifiedpermissions_identity_source": aws_verifiedpermissions_identity_source,
    ...
    "aws_verifiedpermissions_policy_template": aws_verifiedpermissions_policy_template,
    "aws_verifiedpermissions_schema": aws_verifiedpermissions_schema,
    "aws_vpc_block_public_access_exclusion": aws_vpc_block_public_access_exclusion,
    "aws_vpc_block_public_access_options": aws_vpc_block_public_access_options,
    "aws_vpc_encryption_control": aws_vpc_encryption_control,
    "aws_vpc_endpoint_private_dns": aws_vpc_endpoint_private_dns,
    "aws_vpc_endpoint_service_private_dns_verification": aws_vpc_endpoint_service_private_dns_verification,
    "aws_vpc_route_server": aws_vpc_route_server,
    "aws_vpc_route_server_association": aws_vpc_route_server_association,
    "aws_vpc_route_server_endpoint": aws_vpc_route_server_endpoint,
    "aws_vpc_route_server_peer": aws_vpc_route_server_peer,
    "aws_vpc_route_server_propagation": aws_vpc_route_server_propagation,
    "aws_vpc_route_server_vpc_association": aws_vpc_route_server_vpc_association,
    "aws_vpc_security_group_vpc_association": aws_vpc_security_group_vpc_association,
    "aws_vpclattice_domain_verification": aws_vpclattice_domain_verification,
    "aws_vpn_concentrator": aws_vpn_concentrator,
    "aws_wafv2_api_key": aws_wafv2_api_key,
    "aws_wafv2_web_acl_rule_group_association": aws_wafv2_web_acl_rule_group_association,
    "aws_workspacesweb_browser_settings": aws_workspacesweb_browser_settings,
    "aws_workspacesweb_browser_settings_association": aws_workspacesweb_browser_settings_association,
    "aws_workspacesweb_data_protection_settings": aws_workspacesweb_data_protection_settings,
    "aws_workspacesweb_data_protection_settings_association": aws_workspacesweb_data_protection_settings_association,
    "aws_workspacesweb_identity_provider": aws_workspacesweb_identity_provider,
    "aws_workspacesweb_ip_access_settings": aws_workspacesweb_ip_access_settings,
    "aws_workspacesweb_ip_access_settings_association": aws_workspacesweb_ip_access_settings_association,
    "aws_workspacesweb_network_settings": aws_workspacesweb_network_settings,
    "aws_workspacesweb_network_settings_association": aws_workspacesweb_network_settings_association,
    "aws_workspacesweb_portal": aws_workspacesweb_portal,
    "aws_workspacesweb_session_logger": aws_workspacesweb_session_logger,
    "aws_workspacesweb_session_logger_association": aws_workspacesweb_session_logger_association,
    "aws_workspacesweb_trust_store": aws_workspacesweb_trust_store,
    "aws_workspacesweb_trust_store_association": aws_workspacesweb_trust_store_association,
    "aws_workspacesweb_user_access_logging_settings": aws_workspacesweb_user_access_logging_settings,
    "aws_workspacesweb_user_access_logging_settings_association": aws_workspacesweb_user_access_logging_settings_association,
    "aws_workspacesweb_user_settings": aws_workspacesweb_user_settings,
