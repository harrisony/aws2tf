...
def aws_cloudtrail(t1, tt1, tt2, flag1, flag2):
    ...
    skip = 0
    if tt1 == "ends_with" and tt2 == "[]":
        skip = 1
    if tt1 == "not_ends_with" and tt2 == "[]":
        skip = 1
    if tt1 == "starts_with" and tt2 == "[]":
        skip = 1
    if tt1 == "not_starts_with" and tt2 == "[]":
        skip = 1
    if tt1 == "not_equals" and tt2 == "[]":
        skip = 1
    if tt1 == "equals" and tt2 == "[]":
        skip = 1
...
log.debug(
    f"CLOUDTRAIL handlers: 2 custom functions + __getattr__ for 0 simple resources"
)
