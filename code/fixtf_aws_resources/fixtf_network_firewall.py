...
def aws_networkfirewall_logging_configuration(t1, tt1, tt2, flag1, flag2):
    ...
    if tt1 == "firewall_arn" and tt2 != "null" and tt2.startswith("arn:"):
        ...
        tt1 == " tls_inspection_configuration_arn"
        and tt2 != "null"
        and tt2.startswith("arn:")
    ):
        tarn = (
            tt2.replace("/", "_")
            .replace(".", "_")
...
log.debug(
    f"NETWORK_FIREWALL handlers: 3 custom functions + __getattr__ for 0 simple resources"
)
