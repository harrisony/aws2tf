...
def aws_s3_bucket(t1, tt1, tt2, flag1, flag2):
    ...
    if "resource":
        if (
            "aws_s3_bucket_request_payment_configuration" in tt1
            or "aws_s3_bucket_accelerate_configuration" in tt1
            or "aws_s3_bucket_acl" in tt1
            or "aws_s3_bucket_analytics" in tt1
            or "aws_s3_bucket_cors_configuration" in tt1
            or "aws_s3_bucket_intelligent_tiering_configuration" in tt1
            or "aws_s3_bucket_inventory" in tt1
            or "aws_s3_bucket_lifecycle_configuration" in tt1
            or "aws_s3_bucket_logging" in tt1
            or "aws_s3_bucket_metric" in tt1
            or "aws_s3_bucket_notification" in tt1
            or "aws_s3_bucket_object_lock_configuration" in tt1
            or "aws_s3_bucket_ownership_controls" in tt1
            or "aws_s3_bucket_policy" in tt1
            or "aws_s3_bucket_replication_configuration" in tt1
            or "aws_s3_bucket_request_payment_configuration" in tt1
            or "aws_s3_bucket_server_side_encryption_configuration" in tt1
            or "aws_s3_bucket_versioning" in tt1
            or "aws_s3_bucket_website_configuration" in tt1
        ):
            flag2 = True
        else:
            flag2 = False
...
def aws_s3_bucket_object_lock_configuration(t1, tt1, tt2, flag1, flag2):
    skip = 0
    if tt1 == "years" and tt2 == "0":
        skip = 1
    elif tt1 == "days" and tt2 == "0":
        skip = 1
    return skip, t1, flag1, flag2
