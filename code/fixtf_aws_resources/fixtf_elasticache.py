...
def aws_elasticache_cluster(t1, tt1, tt2, flag1, flag2):
    ...
    if context.debug5:
        log.debug(
            "fix aws_elasticache_cluster %s %s %s", tt1, tt2, str(context.elastirep)
        )
    ...
    elif tt1 == "engine" and context.elastirep:
        skip = 1
    elif tt1 == "az_mode" and context.elastirep:
        skip = 1
    elif tt1 == "engine_version" and context.elastirep:
        skip = 1
    elif tt1 == "maintenance_window" and context.elastirep:
        skip = 1
    elif tt1 == "node_type" and context.elastirep:
        skip = 1
    elif tt1 == "node_type" and context.elastirep:
        skip = 1
    elif tt1 == "num_cache_nodes" and context.elastirep:
        skip = 1

    elif tt1 == "parameter_group_name" and context.elastirep:
        skip = 1
    elif tt1 == "port" and context.elastirep:
        skip = 1
    elif tt1 == "snapshot_retention_limit" and context.elastirep:
        skip = 1
    elif tt1 == "snapshot_window" and context.elastirep:
        skip = 1
    elif tt1 == "subnet_group_name" and context.elastirep:
        skip = 1
    elif tt1 == "security_group_ids" and context.elastirep:
        skip = 1
...
def aws_elasticache_global_replication_group(t1, tt1, tt2, flag1, flag2):
    ...
    skip = 0
    if tt1 == "num_node_groups" and tt2 == "0":
        skip = 1
    return skip, t1, flag1, flag2
...
def aws_elasticache_replication_group(t1, tt1, tt2, flag1, flag2):
    ...
    elif tt1 == "auth_token" and tt2 == "null # sensitive":
        skip = 1
    elif tt1 == "auth_token_update_strategy" and tt2 == "null":
        skip = 1

    elif tt1 == "num_cache_clusters" and tt1 != "0":
        context.elasticc = True
    elif tt1 == "num_node_groups":
        if context.elastigrep:
            skip = 1
        elif context.elasticc:
            skip = 1
    elif tt1 == "parameter_group_name" and context.elastigrep:
        skip = 1
    elif tt1 == "engine" and context.elastigrep:
        skip = 1
    elif tt1 == "engine_version" and context.elastigrep:
        skip = 1
    elif tt1 == "node_type" and context.elastigrep:
        skip = 1
    elif tt1 == "security_group_names" and context.elastigrep:
        skip = 1
    elif tt1 == "security_group_ids" and context.elastigrep:
        skip = 1
    elif tt1 == "transit_encryption_enabled" and context.elastigrep:
        skip = 1
    elif tt1 == "at_rest_encryption_enabled" and context.elastigrep:
        skip = 1
...
log.debug(
    f"ELASTICACHE handlers: 4 custom functions + __getattr__ for 0 simple resources"
)
