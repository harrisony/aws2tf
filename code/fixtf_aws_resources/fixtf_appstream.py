...
def aws_appstream_fleet(t1, tt1, tt2, flag1, flag2):
    ...
    skip = 0
    if tt1 == "desired_sessions" and tt2 == "0":
        skip = 1
    if tt1 == "desired_instancess" and tt2 == "0":
        skip = 1
...
def aws_appstream_stack(t1, tt1, tt2, flag1, flag2):
    ...
    skip = 0
    if tt1 == "embed_host_domains" and tt2 == "[]":
        skip = 1
    return skip, t1, flag1, flag2
...
log.debug(
    f"APPSTREAM handlers: 3 custom functions + __getattr__ for 0 simple resources"
)
