                ...
                for k in resp2["agentVersionSummaries"]:
                    ...
                    if av == "DRAFT":
                        common.add_dependancy(
                            "aws_bedrockagent_agent_knowledge_base_association", theid
                        )
                        common.add_dependancy(
                            "aws_bedrockagent_agent_action_group", theid
                        )
...
def get_aws_bedrockagent_agent_knowledge_base_association(
...
def get_aws_bedrockagent_agent_action_group(
    type, id, clfn, descfn, topkey, key, filterid
):
    if context.debug:
        log.debug(
