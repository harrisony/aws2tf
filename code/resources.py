...
def resource_types(type):
    ...
    if type == "net":  # Common VPC networking resources
    ...
    elif type == "api" or type == "apigw":
        rets = ["aws_api_gateway_rest_api"]
        return rets  # API Gateway and dependancies
    elif type == "appmesh":
        rets = ["aws_appmesh_mesh"]
        return rets  # App Mesh and dependancies
    elif type == "apprunner":
    ...
    elif type == "autoscaling" or type == "asg":
        ...
        return rets  # AWS Barch resources
    elif type == "code":
        rets = [
    ...
    elif type == "cloudfront" or type == "cf":
        rets = [
    ...
    elif type == "cloudtrail" or type == "ct":
        rets = ["aws_cloudtrail"]
        return rets  # CloudTrail
    elif type == "cloudwan" or type == "wan":
    ...
    elif type == "groups" or type == "group":
        rets = ["aws_iam_group"]
        return rets  # IAM Groups - aws_iam_group
    elif type == "igw":
        ...
        return rets  # Lambda functions and some dependancies
    elif type == "lb" or type == "elb":
        rets = ["aws_lb"]
        ...
        return rets  # MSK Clusters and dependancies
    elif type == "mwaa":
        rets = ["aws_mwaa_environment"]
        return rets  # MWAA Environment and dependancie
    elif type == "natgw":
        rets = ["aws_nat_gateway"]
        return rets  # NAT gateway and dependancies
    elif type == "nfw":
        ...
        return rets  # AWS Organisations and some dependancies
    elif type == "params":
        rets = ["aws_ssm_parameter"]
        return rets  # SSM parameters
    elif type == "privatelink":
        ...
        return rets  # RDS cluster and some dependancies
    elif type == "s3":
        rets = ["aws_s3_bucket"]
        return rets  # AWS S3 bucket and bucker config
    elif type == "s3tables":
        rets = ["aws_s3tables_table_bucket"]
        return rets  # AWS S3 tables
    elif type == "subnet":
        type = ["aws_subnet"]
        return rets  # AWS subnet and common dependancies
    elif type == "sagemaker":
        rets = [
        ...
        return rets  # SageMaker domain and depandancies
    elif type == "secrets" or type == "secret":
    ...
    elif type == "vpclattice" or type == "lattice":
        rets = [
            "aws_vpclattice_service_network",
            "aws_vpclattice_service",
            "aws_vpclattice_auth_policy",
        ]
        return rets  # VPC Lattice and dependancies
    elif type == "users" or type == "user":
        rets = ["aws_iam_user", "aws_iam_group"]
        return rets  # IAM user and groups
    elif type == "vpc":
        rets = ["aws_vpc"]
        return rets  #  VPC's and its common depandancies
    elif type == "waf":
    ...
    elif type == "workspaces":
        rets = ["aws_workspaces_workspace"]
        return rets  # Aamazon Workspaces
...
def resource_data(type, id):
    ...
    try:
        ...
        log.warning(
            "WARNING:  may not be a Terraform resource ? or it might be being skipped deliberately type=%s",
            type,
        )
